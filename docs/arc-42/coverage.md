...
| 7. Vista de Despliegue | Parcial | [07_deployment_view.md](07_deployment_view.md), diagrama de despliegue | Sin Nivel 2 (contenedores Docker, balanceo de carga, zonas de disponibilidad). |
